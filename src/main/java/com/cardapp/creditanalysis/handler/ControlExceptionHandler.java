package com.cardapp.creditanalysis.handler;
...
import com.cardapp.creditanalysis.handler.exceptions.InvalidUUIDException;
import java.net.URI;
...
public class ControlExceptionHandler {
    ...
    public ProblemDetail httpMessageNotReadableExceptionHandler(HttpMessageNotReadableException ex) {
        final ProblemDetail problemDetail = ProblemDetail.forStatus(HttpStatus.BAD_REQUEST);
        problemDetail.setType(URI.create(""));
        problemDetail.setProperty(TIMESTAMP, LocalDateTime.now());
